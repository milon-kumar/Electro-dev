...
{{--                                <div class="col-sm-5">--}}
{{--                                    <div>--}}
{{--                                        <img src="{{asset('/')}}assets/backend/images/megamenu-img.png" alt="" class="img-fluid mx-auto d-block">--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">--}}
{{--                    <img class="" src="{{asset('/')}}assets/backend/images/flags/us.jpg" alt="Header Language" height="16">--}}
{{--                </button>--}}
