                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card shadow">
                            <form action="{{route('backend.brands.update',optional($brand)->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method("put")
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" type="text" name="name" value="{{optional($brand)->name}}" id="example-text-input">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <img src="{{asset('/')}}uploads/{{optional($brand)->image}}" style="width: 60px;height: 60px;border-radius: 5px;" alt="{{\Illuminate\Support\Str::limit(optional($brand)->slug,10)}}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <select name="status" class="form-control">
                                                <option value="1" {{optional($brand)->status == 1 ? "selected" : ''}} selected>Published</option>
                                                <option value="0" {{optional($brand)->status == 0 ? "selected" : ''}}>Unpublished</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
